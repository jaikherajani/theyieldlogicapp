...
By downloading, installing, or using YieldLogic ("the App"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, do not use the App.
...
- A tax advisory or tax planning service
- A legal advisory service
- A real estate brokerage or agency
- Regulated under any financial services law in any jurisdiction

The developer of YieldLogic is not a registered financial advisor, investment advisor, tax professional, or legal professional in any country or jurisdiction. Nothing in this App constitutes financial, investment, tax, or legal advice of any kind.
...
- Provide financial, investment, or property advice to any other person
- Market, promote, or sell any property, investment product, or financial service to others
- Influence, solicit, or advise any third party to make or avoid any investment decision
- Use App outputs in any professional, commercial, or client-facing capacity
- Reproduce, redistribute, sublicense, or resell the App or any of its content
- Reverse-engineer, decompile, disassemble, or attempt to extract the source code of the App
- Create competing products or services derived from this App
- Scrape, crawl, or systematically extract data or content from the App
- Impersonate the developer or misrepresent the App's outputs as professional advice

Any use outside the permitted scope above is a breach of these Terms and may constitute an infringement of the developer's intellectual property rights.

---

## 4. No Warranties — App Provided "As Is"
...
- Tenant quality and rental collection
- Unexpected maintenance, repairs, or capital expenditure
- Changes in interest rates, loan terms, or lender policies
- Local property market fluctuations
- Tax law changes in your jurisdiction
- Government regulations, rent controls, or zoning changes
- Currency fluctuations
- Force majeure events

Always verify calculations independently and consult qualified professionals before making any financial decision.
...
- A qualified tax accountant or tax advisor familiar with property investment in your jurisdiction
- A licensed real estate agent or buyer's agent
...
- Subscription fees are billed in advance on a recurring basis (monthly or annual) depending on the plan selected.
- Prices are displayed in your local currency as determined by the App Store and may vary by region.
...
- You can manage or cancel your subscription at any time via your Apple ID account settings (Settings → [Your Name] → Subscriptions).

**Free Trial (if offered):**
- If a free trial is offered, unused portions of the trial period are forfeited upon purchasing a subscription.

**Refunds:**
- All purchases are final. Refunds are handled exclusively by Apple in accordance with Apple's App Store refund policy. The developer has no ability to issue refunds directly. To request a refund, visit [reportaproblem.apple.com](https://reportaproblem.apple.com).

**Price Changes:**
- The developer reserves the right to change subscription pricing at any time. Price changes will take effect at the start of the next renewal period. Apple will notify you of any price increases before they take effect, giving you the opportunity to cancel.

**Cancellation:**
- Cancelling a subscription does not result in a prorated refund for the current billing period. You will retain access to Pro features until the end of the paid period.

---

## 10. Eligibility and Account

**Age Requirement:**
- You must be at least **18 years of age** to use this App. By using the App, you represent and warrant that you are 18 years of age or older. If you are under 18, you may not use the App.

**Sign In with Apple:**
- The App uses Sign In with Apple for authentication. You are responsible for maintaining the security of your Apple ID. The developer is not liable for any loss resulting from unauthorised access to your account.
- If you lose access to your Apple ID, you may also lose access to your YieldLogic data. The developer cannot restore access on your behalf.
- You may not create accounts on behalf of third parties or share your account with others.
...
This waiver does not apply where prohibited by law, including in jurisdictions where consumer protection laws limit the enforceability of such waivers.
